...
export type { NavigatorResultData } from '@/lib/journey';
...
/**
 * The dark "next useful step" card used on the Navigator result and Roadmap
 * surfaces. The Dashboard uses its own richer variant in next-move-card.tsx.
 */
